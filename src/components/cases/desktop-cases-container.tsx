          ...
          <CarouselContent>
            {cases.map((caseItem) => {
              const imageUrl = caseItem.homepageImage
                ? urlForImage(caseItem.homepageImage).width(500).height(600).url()
                : caseItem.hero.image
                  ? urlForImage(caseItem.hero.image).width(500).height(600).url()
              ...
              console.log('🔍 Tags type:', Array.isArray(caseItem.hero.tags) ? 'array' : typeof caseItem.hero.tags);
              if (Array.isArray(caseItem.hero.tags) && caseItem.hero.tags.length > 0) {
                console.log('🔍 First tag:', caseItem.hero.tags[0], 'Type:', typeof caseItem.hero.tags[0]);
              }

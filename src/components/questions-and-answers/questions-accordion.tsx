      ...
      >
        {firstFive.map(({ question, answer, id }) => (
          <AccordionItem
            key={id}
            value={`question-${id}`}
            className="border-none rounded-[50px] backdrop-blur-[10px] bg-[rgba(18,18,18,0.26)] shadow-[inset_0_4px_13px_0_rgba(255,255,255,0.25)] transform-[translateZ(0)] backface-hidden"
          >
